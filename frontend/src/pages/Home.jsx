        ...
        <div className="flex flex-col min-h-screen">
            ...
            {loading || authLoading ? (
                ...
                <div className="text-center py-20 text-xl text-gray-500">
                    <div className="text-center">
                        ...
                        <Link to="/login" className="mt-3 inline-block font-semibold text-gray-900 hover:underline">
            ...
            <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
                <div className="flex justify-center items-center gap-2 mb-4">
                    ...
                    <span className="text-xl font-bold text-gray-900">Gatherly</span>
                </div>
                ...
                <div className="text-xs text-gray-400 font-medium uppercase tracking-wider">
                    &copy; {new Date().getFullYear()} Gatherly Platform. All rights reserved.
                </div>
            </footer>
        </div>
    );
