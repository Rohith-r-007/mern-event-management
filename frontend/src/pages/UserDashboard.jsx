                                ...
                                {booking.eventId ? (
                                    <>
                                        ...
                                        <div className="text-sm text-gray-500 mb-4 space-y-1">
                                            <p><strong className="text-gray-700">Date:</strong> {booking.eventId.date ? new Date(booking.eventId.date).toLocaleDateString() : 'N/A'}</p>
                                            <p><strong className="text-gray-700">Amount:</strong> {booking.totalPrice === 0 ? 'Free' : `₹${booking.totalPrice}`}</p>
                                            <p><strong className="text-gray-700">Requested:</strong> {booking.createdAt ? new Date(booking.createdAt).toLocaleDateString() : 'N/A'}</p>
                                        </div>
                                    </>
                                ) : (
