...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (responseData.needsVerification) {
                setShowOTP(true);
                setMessage('Account not verified. Enter the OTP sent to your email.');
            } else {
    ...
    return (
        <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            {message && <div className="bg-blue-50 text-blue-700 p-3 rounded-lg mb-6 text-center shadow-inner border border-blue-100">{message}</div>}
